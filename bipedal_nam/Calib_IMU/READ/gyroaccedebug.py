# Madgwick fusion 1 IMU + ghi CSV. Xem docs/analysis.md
...
IMU.setFullScaleRangeGyro(qwiic_icm20948.dps500)  # cùng FSR với lúc calib gyro
...
# Tên log lấy từ tham số dòng lệnh: python3 gyroaccedebug.py 30deg  -> logs/30deg<timestamp>.csv
TAG = sys.argv[1] if len(sys.argv) > 1 else "run"
csv_path = LOG_DIR / f"{TAG}{time.strftime('%Y%m%d_%H%M%S')}.csv"
